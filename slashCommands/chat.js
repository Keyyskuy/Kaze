...
module.exports = {
  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message, GuildSettings) => {
    ...
    //console.log(interaction, StringOption)
     ...
     .then(data => {
       if(!data.cnt){
        interaction?.editReply({content: "*Sorry I am clueless... I can't connect to the API!*", ephemeral: true}).catch(e => console.log("CHATBOT:".underline.red + " :: " + e.stack.toString().grey));
       }else{
