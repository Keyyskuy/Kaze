    ...
    try {
      ...
      if (args[0].toLowerCase() === `song`) {
        ...
        let embed = new MessageEmbed()
          .setDescription(player.trackRepeat ? client.la[ls].cmds.music.loop.track.disabled : client.la[ls].cmds.music.loop.track.enabled)
          .setColor(es.color)
      ...
      //if input is queue
        ...
        //Create the Embed
        let embed = new MessageEmbed()
          .setDescription(player.queueRepeat ? client.la[ls].cmds.music.loop.queue.disabled : client.la[ls].cmds.music.loop.queue.enabled)
          .setColor(es.color)
