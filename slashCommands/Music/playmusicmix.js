...
blues, oldgaming, pop, remixes, rock, strange-fruits-gaming
  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message, GuildSettings) => {
    ...
    try {
      let link = "https://open.spotify.com/playlist/38Gwsj6ktf3z1rVfmmeXSo";
      ...
      if (args[0]) {
        ...
        //pop
        if (args[0].toLowerCase().startsWith("p")) link = "https://open.spotify.com/playlist/38Gwsj6ktf3z1rVfmmeXSo";
        //default
        if (args[0].toLowerCase().startsWith("d")) link = "https://open.spotify.com/playlist/38Gwsj6ktf3z1rVfmmeXSo";
        ...
        //rock
        if (args[0].toLowerCase().startsWith("ro")) link = "https://open.spotify.com/artist/79JgYJHiBUZcvYqOC5Zufn";
        //oldgaming
        ...
        //Jazz
        if (args[0].toLowerCase().startsWith("j")) link = "https://open.spotify.com/playlist/5IiBlSiPiKf3E46o0p7q93";
        //blues
