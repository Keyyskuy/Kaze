    ...
    try {
      ...
      switch (Type.toLowerCase()) {
        ...
        case `addcurrenttrack`: {
          ...
          //return susccess message
          return message.reply({embeds : [new MessageEmbed()
            .setTitle(`<a:yes:859388948026621982> Added ${track.title} onto the Queue \`${Name}\``.substring(0, 256))
        ...
        case `removesong`: {
          ...
          //return susccess message
          return message.reply({embeds :[new MessageEmbed()
            .setTitle(`<a:yes:859388948026621982> Deleted ${deletetrack.title} of the Queue \`${Name}\``.substring(0, 256))
        ...
        case `mix`: {
          ...
          //return susccess message
          return message.reply({embeds : [new MessageEmbed()
            .setTitle(`<a:yes:859388948026621982> Shuffled ${newtracks.length} Tracks of the Queue \`${Name}\``.substring(0, 256))
        ...
        case `removeduplicates`: {
          ...
          //return susccess message
          return message.reply({embeds : [new MessageEmbed()
            .setTitle(`<a:yes:859388948026621982> Removed ${counter} Tracks from the Queue \`${Name}\``.substring(0, 256))
