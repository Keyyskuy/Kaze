    ...
    try {//ensure the database
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          .setColor(es.color)
          .setAuthor(client.getAuthor('Join VC System', 'https://cdn.discordapp.com/emojis/834052497492410388.gif?size=96', 'https://dsc.gg/devraiden'))
        ...
        switch (optionhandletype){
          case "Send Message in a Channel":{
            ...
            async function second_layer(){
              ...
              let MenuEmbed = new Discord.MessageEmbed()
                .setColor(es.color)
                .setAuthor('Join VC System', 'https://cdn.discordapp.com/emojis/834052497492410388.gif?size=96', 'https://dsc.gg/devraiden')
                .setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-ticket"]["variable2"]))
              //send the menu msg
              let menumsg = await message.reply({embeds: [MenuEmbed], components: [new MessageActionRow().addComponents(Selection)]})
              //Create the collector
                ...
                case "Add a VC": {
                  ...
                  await tempmsg.channel.awaitMessages({filter: m => m.author.id === message.author?.id,
                    ...
                    .then(async collected => {
                      ...
                      if(!Voicechannel || !Textchannel || Voicechannel.type != "GUILD_VOICE" || Textchannel.type != "GUILD_TEXT") return message.reply("**Check the example in the Embed, wrong input type!**")
                      try {
                        ...
                        if(a.map(d => d.channelId).includes(Voicechannel.id))
                          return message.reply({embeds: [new Discord.MessageEmbed()
                            .setTitle(`<a:no:859388931894935613> This Channel is already Setupped!`)
                        ...
                        return message.reply({embeds: [new Discord.MessageEmbed()
                          .setTitle(`<a:yes:859388948026621982> I will now send Messages after someone joins the VC \`${Voicechannel.name}\` in the TextChannel **${Textchannel.name}**`)
                          .setColor(es.color)
                          .setFooter(client.getFooter(es))
                        ]});
                      } catch (e) {
                ...
                case "Remove a VC": {
                  ...
                  await tempmsg.channel.awaitMessages({filter: m => m.author.id === message.author?.id,
                    ...
                    .then(async collected => {
                      ...
                      if(!Voicechannel || Voicechannel.type != "GUILD_VOICE") return message.reply("**Check the example in the Embed, wrong input type!**")
                      try {
                        let a = await client.joinvc.get(message.guild.id+".vcmessages")
                        //remove invalid ids
                        for await (const vc of a){
                        ...
                        if(!a.map(d => d.channelId).includes(Voicechannel.id))
                          return message.reply({embeds: [new Discord.MessageEmbed()
                            .setTitle(`<a:no:859388931894935613> This Channel has not been Setup yet!`)
                            .setColor(es.color)
                            .setFooter(client.getFooter(es))
                          ]});
                        await dbRemove(client.joinvc, message.guild.id+".vcmessages", d => d.channelId == Voicechannel.id)
                        return message.reply({embeds: [new Discord.MessageEmbed()
                          .setTitle(`<a:yes:859388948026621982> Successfully removed **${Voicechannel.name}** out of the Setup!`)
                          .setColor(es.color)
                          .setFooter(client.getFooter(es))
                        ]});
                      } catch (e) {
                ...
                case "Add a VC": {
                  ...
                  await tempmsg.channel.awaitMessages({filter: m => m.author.id === message.author?.id,
                    ...
                    .then(async collected => {
                      ...
                      if(!Voicechannel || !Role) return message.reply("**Check the example in the Embed, wrong input type!**")
                      ...
                      try {
                        ...
                        return message.reply({embeds: [new Discord.MessageEmbed()
                          .setTitle(`<a:yes:859388948026621982> I will now Add the Role \`${Role.name}\` when someone joins the VC **${Discord.VoiceChannel.name}**`)
                          .setColor(es.color)
                          .setFooter(client.getFooter(es))
                        ]});
                      } catch (e) {
