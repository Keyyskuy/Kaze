        ...
        switch(menuoptionindex){
          case 0: {
            ...
            return message.reply({embeds: [new Discord.MessageEmbed()
              .setTitle(`<a:yes:859388948026621982> The Anti Discord Setup is now ${d2p(!previous)}!`)
              .setColor(es.color)
          ...
          case 5: {
            ...
            if(antisettings.length < 1) return message.reply("There are no links whitelisted...")
            tempmsg = await message.reply({embeds: [new Discord.MessageEmbed()
          ...
          case 6: {
            ...
            .then(async collected => {
              ...
              if (message.content) {
                ...
                if(isNaN(number)) return message.reply("**Not a valid Number**");
                if(Number(number) < 0 || Number(number) > 15) return message.reply("**The Number must be between `0` and `15`**");
