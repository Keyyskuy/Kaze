    ...
    try {
      await dbEnsure(client.settings, message.guild.id, {
        boost: {
          ...
          message: "",
          log: false,
          stopBoost: "<a:boost:860434742871851048> {member} **stopped Boosting us..** <:Cat_Sad:867722685949804565>",
          startBoost: "<a:boost:860434742871851048> {member} **has boosted us!** <a:Light_Saber_Dancce:867721861462229013>",
          againBoost: "<a:boost:860434742871851048> {member} **has boosted us again!** <:Tada_WON:867724032207224833>",
        }
      })
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(es.color)
          .setAuthor(client.getAuthor('Boost-Log', 'https://cdn.discordapp.com/emojis/833402717950836806.gif?size=128&quality=lossless', 'https://dsc.gg/devraiden'))
