    ...
    try {
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          .setColor(es.color)
          .setAuthor(client.getAuthor('Auto-Warn Setup', 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/apple/285/prohibited_1f6ab.png', 'https://dsc.gg/devraiden'))
        ...
        collector.on("collect", async b => {
          ...
          return b?.reply({content: "Only the one who typed the Command is allowed to select Things!", ephemeral: true});
          ...
          b?.reply(`<a:yes:859388948026621982> **\`Enabled ${enabled} Auto-Warn-Rules\` and \`Disabled ${disabled} Auto-Warn-Rules\` out of \`${b?.values.length} selected Auto-Warn-Rules\`**`)
        })
        collector.on('end', collected => {
          menumsg.edit({content: "Time ran out/Input finished! Cancelled", embeds: [
            menumsg.embeds[0]
