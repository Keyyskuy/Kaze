...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls, GuildSettings) => {
      ...
      const embed = new Discord.MessageEmbed()
        ...
        .addField('<:row:965645261739262012> **Name**', "```"+json.name+"```", true)
        .addField("<:row:965645261739262012> **Hex**",  "```"+json.hex+"```", true)
        .addField("<:row:965645261739262012> **RGB**",  "```"+json.rgb+"```", true)
        .addField(`<:row:965645261739262012> **${client.la[ls].cmds.info.color.brightershade}**`,  "```"+json.brightened +"```", true)
