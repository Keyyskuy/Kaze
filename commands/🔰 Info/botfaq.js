...
module.exports = {
    ...
    run: async (client, message, args, cmduser, text, prefix, player, es, ls, GuildSettings) => {
      ...
      const membersWithRoleResult = await client.cluster.broadcastEval(async (client) => {
        const guild = client.guilds.cache.get("904199007822303242");
      ...
      .setColor(es.color)
      .setAuthor(client.la[ls].cmds.info.botfaq.menuembed.title, client.user.displayAvatarURL(), "https://dsc.gg/devraiden")
